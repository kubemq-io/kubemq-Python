...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in kubemq/grpc/kubemq_pb2_grpc.py depends on"
...
def add_kubemqServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("kubemq.kubemq", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("kubemq.kubemq", rpc_method_handlers)
