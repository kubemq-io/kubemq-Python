...
import grpc
import grpc.experimental  # type: ignore[import-untyped]  # noqa: F401
from kubemq_pb2 import Event, Result  # type: ignore[import-not-found]
from kubemq_pb2_grpc import kubemqStub  # type: ignore[import-not-found]
                ...
                for response in responses:
                    ...
                    with self._lock:
                        if response_event_id in self._response_tracking:
                            response_container, response_event = self._response_tracking[
                                response_event_id
                            ]
