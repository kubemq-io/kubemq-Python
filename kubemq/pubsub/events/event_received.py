...
class EventReceived:
    def __init__(self, id: str = None, from_client_id: str = None, timestamp: datetime = None,
                 channel: str = None, metadata: str = None, body: bytes = None, tags: Dict[str, str] = None):
        self._id: str = id
    ...
    @staticmethod
    def from_event(event_receive: pbEventReceive) -> 'EventReceived':
