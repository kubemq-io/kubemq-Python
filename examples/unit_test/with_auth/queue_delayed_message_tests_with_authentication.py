...
class TestStringMethods(unittest.TestCase):
    ...
    def test_delayed_message_pass(self):
        ...
        message = create_queue_message("queueName {}".format(0), "some-simple_queue-queue-message".encode('UTF-8'),
                                       queuePolicy)
        mm.append(message)
        ...
        message2 = create_queue_message("queueName {}".format(1), "some-simple_queue-queue-message".encode('UTF-8'),
                                        queuePolicy2)
        mm.append(message2)
